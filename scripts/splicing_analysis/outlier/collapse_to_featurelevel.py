...
with open(infile,"r") as f_read:
	for line in f_read.readlines():
		...
		junc_name=line_split[9]
		score=line_split[10]
		strand=line_split[11]
		splice_site=line_split[12]
		acceptors_skipped=line_split[13]
		exons_skipped=line_split[14]
		donors_skipped=line_split[15]
		anchor=line_split[16]
		known_donor=line_split[17]
		known_junction=line_split[18]
		enst=line_split[21]
		#enst=line_split[10]
		...
		#(enst_or_ensg)
		store_line=[chrom,start,end,cluster, sample,z,junc_name,score,strand,splice_site,acceptors_skipped,exons_skipped,donors_skipped,anchor,known_donor,known_junction,enst,enst_or_ensg]
